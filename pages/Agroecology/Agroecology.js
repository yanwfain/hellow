...
Page({
  data: {
    arr: [
      "号外！号外！及及在身边+生态农业圈正式上线运营啦~",
      "现全国范围招商中，欢迎各农场主/庄园主火热入驻！"
    ],
    banner: [
      {
        imgUrls: "http://www.shanxingniao.com/imgServer/images/use_test/nongyeshengtai/pt1.jpg",//banner路径
        code: '3'//景区官网唯一标识
      },
      {
        imgUrls: "http://www.shanxingniao.com/imgServer/images/use_test/nongyeshengtai/pt2.jpg",//banner路径
        code: '2'//官网唯一标识
      },
      {
        imgUrls: "http://www.shanxingniao.com/imgServer/images/use_test/nongyeshengtai/pt3.jpg",//banner路径
        code: '1'//官网唯一标识
      }
    ],
    // navXiao:[
  ...
  introd(){
    wx.navigateTo({
      url:"../platformIntrod/platformIntrod"
    })
  },
  // 方形导航事件
  goNav(e) {
...
// 首页banner
function travelHomeBanner(that, options) {
